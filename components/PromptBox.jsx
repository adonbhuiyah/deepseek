...
const handleBackground = (e) => {
  ...
  if (
    ...
    button.querySelector("path").classList.add("isActiveIcon");
  } else {
    button.classList.remove("isActive");
    button.querySelector("path").classList.remove("isActiveIcon");
  }
};
...
const PromptBox = ({ isLoading, setIsLoading }) => {
  ...
  return (
    <form
      ...
      } mt-4 rounded-3xl bg-[#404045] p-4 transition-all`}
    >
      <textarea
      ...
      <div className="flex items-center justify-between text-sm">
        <button
          type="button"
          className="flex cursor-pointer items-center gap-2 rounded-full border border-gray-300/40 px-2 py-1 text-xs"
